...
/**
 * Renders the application settings page with controls for user role, theme selection,
 * display preferences, admin PIN management (admin only), and a data reset action.
 *
